...
<body class="bg-zinc-900">
    ...
    <footer class="footer p-10 bg-zinc-800 text-neutral-content">
  <div class="ml-14">
  <a class=" normal-case text-3xl  text-black font-extrabold" href="index.php">App<span class="text-3xl text-red-800">Game</span></a>
    <p>ACME Industries Ltd.<br>Copyright © 2022 - All right reserved by App<span class=" text-red-800">Game</span> Industries Ltd</p>
  </div> 
  <div>
